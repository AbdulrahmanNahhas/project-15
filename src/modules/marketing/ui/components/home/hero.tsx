...
export const Hero = () => {
  return (
    <div className="flex flex-col items-center text-center w-full max-w-5xl mb-12 mt-32 mx-auto z-40 relative">
      ...
      <h1
        className="text-3xl sm:text-5xl font-bold lg:text-6xl xl:text-7xl bg-linear-to-br from-foreground to-foreground/60 bg-clip-text text-transparent py-2 md:py-0 lg:leading-snug! racking-[-0.0125em] mt-2 font-heading">
        المنصة السورية
      </h1>
      <div>
